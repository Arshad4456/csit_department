                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2 ">
                        <div class="card-body">
                            ...
                            <button class="btn bg-warning text-dark"><a href="../Enrollement_Form/Enrollement_Form.html" class="text-decoration-none">Apply</a></button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="card-body">
                            ...
                            <button class="btn bg-warning text-dark"><a href="../Leave_Application/Leave_application.html" class="text-decoration-none">Application Form</a></button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="card-body">
                            ...
                            <button class="btn bg-warning text-dark"><a href="../GPA_Predictions/GPA_Predictions.html" class="text-decoration-none">Calculate Your GPA Here</a></button>
                        </div>
                    </div>
                </div>
            </div>
